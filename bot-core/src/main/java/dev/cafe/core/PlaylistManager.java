...
public class PlaylistManager {
  ...
  public String loadPlaylistToQueue(String playlistId, AudioController audioController, long guildId) {
    Playlist playlist = playlists.get(playlistId);
    if (playlist == null) {
    ...
    return String.format("Loaded %d tracks from playlist '%s' to queue.", 
        tracks.size(), playlist.getName());
  }
